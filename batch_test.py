...
for window in (1200, ):
	for ovr in (2, ):
		for decimation in (0,):
			...
			rnn_ppg.x_data, rnn_ppg.y_data, rnn_ppg.subj_inputs = rnn_ppg.create_dataset(rnn_ppg.window, rnn_ppg.overlap, rnn_ppg.decimation, distrib_stat = 5)
			if rnn_ppg.oversample:
				rnn_ppg.x_data, rnn_ppg.y_data, rnn_ppg.subj_inputs = rnn_ppg.oversampling(rnn_ppg.x_data, rnn_ppg.y_data, rnn_ppg.subj_inputs, 5)
			rnn_ppg.train_session(save_model = True)
